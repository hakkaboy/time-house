 ...
 */
public class PradaPuzzleGameScene extends SimpleBaseGameActivity implements IOnSceneTouchListener, IScrollDetectorListener, IPinchZoomDetectorListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private HashMap<Puzzle, ITextureRegion> mCardTotextureRegionMap;
	...
	public void onCreateResources() {
		...
		BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mCardDeckTexture, this, "puzzle_bike.jpg", 0, 0);
		this.mCardDeckTexture.load();

		this.mCardTotextureRegionMap = new HashMap<Puzzle, ITextureRegion>();

		/* Extract the TextureRegion of each card in the whole deck. */
		for(final Puzzle puzzle : Puzzle.values()) {
//		for(int i=0;i<10;i++){
			final ITextureRegion cardTextureRegion = TextureRegionFactory.extractFromTexture(this.mCardDeckTexture, puzzle.getTexturePositionX(), puzzle.getTexturePositionY(), Puzzle.PUZZLE_WIDTH, Puzzle.PUZZLE_HEIGHT);
...
//		this.addCard(Card.SPADE_ACE, 440, 260);
		...
		for(final Puzzle puzzle : Puzzle.values()) {
			this.addPuzzle(puzzle, random.nextInt(300), random.nextInt(300));
		}
//		this.addPuzzle(Puzzle.PICS_01, 200, 100);
//		this.addPuzzle(Puzzle.PICS_02, 200, 260);
//		this.addPuzzle(Puzzle.PICS_03, 440, 100);
//		this.addPuzzle(Puzzle.PICS_04, 440, 260);
	...
	private void addPuzzle(final Puzzle pCard, final int pX, final int pY) {
